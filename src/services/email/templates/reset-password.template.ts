				...
				<td style="padding: 36px 30px 42px 30px">
				  ...
				  >
					<tr>
					  <td align="center">
						<img
						  src="https://i.ibb.co/NmhTcV7/password-reset.png"
						  alt="password-reset"
						  width="150px"
					...
					<tr>
					  <td style="padding: 0 0 36px 0; color: #010137">
						...
						<p
						  ...
						  "
						>
						  Need to reset your password? No problem! Enter the OTP
						  code below to reset your password. If you did not make
